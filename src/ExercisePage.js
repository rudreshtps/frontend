  ...
  const progress =
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
		  let url = `https://surgebackend.azurewebsites.net/exercise/${storedChapterId}/${storedStudentId}`;
 ...
 const handleNextQuestion = () => {
    ...
    const handleAnswerSelection = () => {
      ...
      sessionStorage.setItem("entered_answer", selectedOption);
       ...
       console.log("=========================")     
        fetch('https://surgebackend.azurewebsites.net/exercise/add', {
          method: 'POST',
          headers: {
      ...
      const handleFinish = () => {
        alert('Quiz finished!');
        const url = `https://surgebackend.azurewebsites.net/exercise/finish/${course}/${nextChapterId}/${studentId}`;
        console.log(url)
        axios.post(url)
        .then(response => {
